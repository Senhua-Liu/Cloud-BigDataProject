...
There are some images inside iam quizz and network quizz folder. Your job is to answer the questions by specifying correct answers. For example if the first option is the correct answer, say Option 1
# IAM
